...
class Ogre extends Monster {
    ...
    public function __construct(array $data) 
    {
     ...
     public function hit(Hero $hero) : int {
        if ($hero instanceof Archer) { // instanceof vérifie si un objet est une instance d'une certaine classe
            $damage = rand(0, 25) * 2; // inflige deux fois plus de dégâts contre un archer
        } else {
